 ...
 * @version 1.6
 * 
 * Clase que permite crear un objeto baldosa de caracteristica "piso". Clase hija que extiende de Baldosa.
...
public class ImgBaldosaPiso extends ImgBaldosa{

	public ImgBaldosaPiso(int id) {
        super(Recurso.baldosapiso, id);
    }
}
