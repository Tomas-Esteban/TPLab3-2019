 ...
 * @version 1.6
 * 
 * Clase que permite crear un objeto baldosa de caracteristica "cesped oscuro".Clase hija que extiende de Baldosa.
 ...
 *  
 */
public class ImgBaldosaCespedOscuro extends ImgBaldosa {

    public ImgBaldosaCespedOscuro(int id) {
