 ...
 * @version 1.6
 * 
 * Clase que permite crear un objeto oro para la Tienda. Clase hija que extiende de Baldosa.
...
public class ImgOro extends ImgBaldosa {

	public ImgOro(int id) {
		super(Recurso.imgoro, id);
